...
const Navbar = () => {
  ...
  const navlink = (
    <div className="flex flex-col lg:flex-row gap-3 text-lg font-medium ">
      ...
      <NavLink to={"/allArtCraftItems"}>All Art & craft products</NavLink>
      <span className="hidden lg:inline-block">|</span>
      <NavLink to={"/addCraft"}>Add Craft products</NavLink>
      <span className="hidden lg:inline-block">|</span>
      <NavLink to={"/myArtAndCraft"}>Product List</NavLink>
    </div>
  );
  return (
      ...
      <div className="navbar container mx-auto lg:px-12">
        <div className="navbar-start">
          ...
          <a className="p-1 btn-ghost text-xl lg:text-3xl font-medium flex flex-col">
            <span className="text-[#D24545]">Arts</span>
